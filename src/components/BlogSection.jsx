    ...
    <div className="flex flex-col  pb-24 gap-16 items-center px-4 ">
      <div className="flex justify-between gap-16  lg:px-12 w-[85%]">
        <div className="flex flex-col gap-2">
          <span className="text-[#e04c4c] font-semibold">Our blogs</span>
        ...
        <div className="hidden xl:block">
          <Link className="px-5 py-3 bg-[#e04c4c] rounded-md text-white">
            View all posts
          </Link>
        </div>
      </div>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <div className=" w-[370px] h-[440px] flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h1 className="text-[#e04c4c] font-medium">Design</h1>
          ...
          <div className=" w-[370px] h-[440px] flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h1 className="text-[#e04c4c] font-medium">Product</h1>
                <div className="flex items-center justify-between">
                  <h1 className="text-xl font-medium">
          ...
          <div className=" w-[370px] h-[440px] flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                <h1 className="text-[#e04c4c] font-medium">
