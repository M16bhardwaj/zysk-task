        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4">
            <div className="text-center mx-auto mb-12 lg:mb-20 md:w-[768px] md:h-[160px] flex flex-col items-center gap-3">
              <span className="font-semibold text-lg mb-2 block text-[#e64a4a]">
                Features
              </span>
          ...
          <div className="">
            <div className=" rounded-md   gap-5 w-[350px] h-[160px]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className=" text-center">
                  An all-in-our customer service platform that helps you balance
            ...
            <div className=" rounded-md   gap-5 w-[350px] h-[160px]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className=" text-center">
                  ...
                  ofour resources are free. Chat to our friendly team 24/7 when
                  you need help
                </p>
              </div>
            </div>
